...
class TurboencabulatorWordlist(Wordlist):
    ...
    def adjectives(self):
        ...
        return [word["lemma"] for sentence in processed['sentences']
                for word in sentence if word["pos"] == "ADJ"]

    @property
    def nouns(self):
        processed = self.__process__()
        return [word["lemma"] for sentence in processed['sentences']
                for word in sentence if word["pos"] == "NOUN"]
